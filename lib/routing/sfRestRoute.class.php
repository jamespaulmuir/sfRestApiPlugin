...
/**
 * sfRestRoute represents a route that is bound to a Rest module
 *
 *
 *
 * @package    symfony
 ...
 */
class sfRestRoute extends sfObjectRoute
{
  protected
    $query = null;
  ...
  public function getParameters()
  {
     ...
     unset($parameters['module'], $parameters['action'],$parameters['sf_format']);
    return $parameters;
  }
}